...
#define Reflect0(CLS)                                 \
    ...
    void *get_pointer_0(const CLS &, const char *)    \
    {                                                 \
        return NULL;                                  \
    }                                                 \
...
#define ReflectGet(MET, FUN, CLS, X, Y)           \
...
#define ReflectMethod1(MET, FUN, CLS, X) \
    ReflectGet(MET, FUN, CLS, X, 0);
#define ReflectMethod2(MET, FUN, CLS, X, Y) \
    ReflectGet(MET, FUN, CLS, Y, 0);        \
    ReflectGet(MET, FUN, CLS, X, Y);
#define ReflectMethod3(MET, FUN, CLS, X, Y, Z) \
    ReflectGet(MET, FUN, CLS, Z, 0);           \
    ReflectGet(MET, FUN, CLS, Y, Z);           \
    ReflectGet(MET, FUN, CLS, X, Y);
